                            ...
                            MaterialAboutActionItem.Builder()
                                ...
                                .setOnClickAction {
                                    requireContext().launchCustomTab(
                                        "https://github.com/Begitdj/NekoBoxForAndroid/releases"
                                    )
                                }
                                .build())
                        .addItem(
                    ...
                    MaterialAboutCard.Builder()
                        ...
                        .addItem(
                            MaterialAboutActionItem.Builder()
                                ...
                                .setOnClickAction {
                                    requireContext().launchCustomTab(
                                        "https://github.com/Begitdj/NekoBoxForAndroid"
            ...
            runOnIoDispatcher {
                try {
                    ...
                    val response = client.newRequest().apply {
                        if (checkPreview) {
                            setURL("https://api.github.com/repos/Begitdj/NekoBoxForAndroid/releases/tags/preview")
                        } else {
                            setURL("https://api.github.com/repos/Begitdj/NekoBoxForAndroid/releases/latest")
                        }
                    }.execute()
